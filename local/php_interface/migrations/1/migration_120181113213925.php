...
class migration_120181113213925 extends Version
{

    protected $description = "videos";
  ...
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/simai_content/index.php?ID=#IBLOCK_ID#',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/simai_content/detail.php?ID=#ELEMENT_ID#',
  'SECTION_PAGE_URL' => '#SITE_DIR#/simai_content/list.php?SECTION_ID=#SECTION_ID#',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  array (
    ...
    'NAME' => 'Название',
    'SORT' => 'Сортировка',
    'PREVIEW_PICTURE' => 'Превью картинка видео',
    'PREVIEW_TEXT' => 'Ссылка',
  ),
  'Подробно' => 
  array (
