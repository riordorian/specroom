...
$MESS["AUTH_FORGOT_PASSWORD_SHORT"] = "Вспомнить";
...
$MESS["LOGIN_ACCAUNT"]="Войти в <strong>аккаунт</strong>";
$MESS["URL_PERSONAL"]="Личные данные";
$MESS["URL_BASKET"]="Корзина";
$MESS["URL_ORDER"]="Мои заказы";
$MESS["URL_SUBSCRIBE"]="Подписка";
?>