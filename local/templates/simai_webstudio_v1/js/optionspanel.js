jQuery(document).ready(function($) {
	...
	$("#stylechanger .color a").click(function() { 
		$("#t-colors").attr("href",$(this).attr('data-rel'));
		$.cookie("css",$(this).attr('data-rel'), {expires: 365, path: '/'});
		return false;
	});
	
	$(".bgr .color a").click(function() { 
		$("#bodybg").attr("href",$(this).attr('data-rel'));
		$.cookie("css",$(this).attr('data-rel'), {expires: 365, path: '/'});
		return false;
	});
